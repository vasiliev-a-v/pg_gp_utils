...
Имя файла будет отображено в стандартном выводе, а также в лог-файле утилиты adbmt.  
Например:
```
...
TOOL_OPTIONS:                                        - Текущие значения:
  ...
  -help
    Показать эту памятку по использованию на английском языке и выйти.

  -help-ru
    Показать эту памятку по использованию на русском языке и выйти.
```
